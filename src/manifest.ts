...
export const SPEC_SLUGS: string[] = [
  ...
  "currency-historical-data-limit",
  "currency-rate",
  "currency-supported",
  "currency-symbols",
  ...
  "email-checker",
  "bulk-vat-rates-country",
  "financial-apis-supported-countries",
  "iban-validation",
  "swift-code-finder",
  "swift-code-lookup",
  ...
  "zip-codes-by-city",
  "zip-codes-by-region",
  "zip-codes-radius-search",
];

export const SPEC_CATEGORIES: string[] = [
  "commodity",
  "currency",
  "dns",
  "domain",
...
export type SpecCategoryValue =
  (typeof SpecCategory)[keyof typeof SpecCategory];
