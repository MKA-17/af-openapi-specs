...
export { SPEC_SLUGS, SPECS, SPEC_CATEGORIES, SPECS_BY_CATEGORY, SpecSlug, SpecCategory } from './manifest.js';
...
export function getSpec(slug: SpecSlugValue | (string & {})): OpenAPISpec | undefined {
  return SPECS[slug];
}

export function getSpecsByCategory(category: SpecCategoryValue | (string & {})): string[] {
